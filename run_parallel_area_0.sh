...
#SBATCH --ntasks 40
# job name
#SBATCH --job-name=grid_dict_parall_0
# job stdout file
#SBATCH --output=logs/grid_dict_parall_0.out.%J
# job stderr file
#SBATCH --error=logs/grid_dict_parall_0.err.%J
...
# Run the tasks:
$parallel "$srun python grid_to_gid_0.py {1}" :::: input/limits.txt
