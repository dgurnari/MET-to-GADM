...
#SBATCH --ntasks 37
# job name
#SBATCH --job-name=grid_dict_parall_2
# job stdout file
#SBATCH --output=logs/grid_dict_parall_2.out.%J
# job stderr file
#SBATCH --error=logs/grid_dict_parall_2.err.%J
...
# Run the tasks:
$parallel "$srun python grid_to_gid_2.py {1}" :::: input/countries.txt
